...
public class Main {
    public static void main(String[] args) {
        ...
        // 가격이 가장 비싼 책 가격 조회
//        Book maxPriceBook = bookList.stream().max(Comparator.comparing((Book b) -> b.getPrice())).get();
//        System.out.println("책 목록 중 가장 비싼 금액: " + maxPriceBook.getPrice());

       // double maxPrice = bookList.stream().mapToDouble((book) -> book.getPrice()).max().orElseThrow(() -> new NoSuchElementException());
